...
public class HexGridChunk : MonoBehaviour
{
    ...
    void TriangulateWaterShore (HexDirection direction, HexCell cell, HexCell neighbor, Vector3 center)
    {
        ...
        {
            shore.AddQuad (e1.v1, e1.v2, e2.v1, e2.v2);
            shore.AddQuad (e1.v2, e1.v3, e2.v2, e2.v3);
            shore.AddQuad (e1.v3, e1.v4, e2.v3, e2.v4);
            shore.AddQuad (e1.v4, e1.v5, e2.v4, e2.v5);
            shore.AddQuadUV (0f, 0f, 0f, 1f);
            shore.AddQuadUV (0f, 0f, 0f, 1f);
            shore.AddQuadUV (0f, 0f, 0f, 1f);
            shore.AddQuadUV (0f, 0f, 0f, 1f);
            shore.AddQuadCellData (indices, weights1, weights2);
            shore.AddQuadCellData (indices, weights1, weights2);
            shore.AddQuadCellData (indices, weights1, weights2);
            shore.AddQuadCellData (indices, weights1, weights2);
        }
        ...
        if (nextNeighbor != null)
        {
            ...
            v3.y = center.y;
            shore.AddTriangle (e1.v5, e2.v5, v3);
            shore.AddTriangleUV (
                new Vector2 (0f, 0f),
                new Vector2 (0f, 1f),
    ...
    {
        shore.AddTriangle (e2.v1, e1.v2, e1.v1);
        shore.AddTriangle (e2.v5, e1.v5, e1.v4);
        shore.AddTriangleUV (
        ...
        shore.AddTriangleCellData (indices, weights2, weights1, weights1);
        shore.AddTriangleCellData (indices, weights2, weights1, weights1);
